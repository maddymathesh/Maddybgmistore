...
import {
  ShieldCheck, MapPin, CreditCard, Info, AlertTriangle, Users,
  Clock, FileText, Check, Award, MessageCircle, Send,
  ShieldAlert, Coins, Sparkles, Navigation, Search, ChevronDown, CheckCircle
} from "lucide-react";

export default function F2FSellGuide() {
  useSEO(
    "Face-to-Face Seller Protocol & Midpoint Hub",
    "Complete seller guidelines and interactive midpoint calculator for premium, high-value BGMI face-to-face transactions."
  );
      ...
      <div style={containerStyle}>
        ...
        <section style={{
          ...
          <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
            <div style={{ position: "absolute", width: "400px", height: "400px", background: "radial-gradient(circle, rgba(255,215,0,0.04) 0%, transparent 70%)", top: "-100px", left: "-100px" }} />
            <div style={{ position: "absolute", width: "400px", height: "400px", background: "radial-gradient(circle, rgba(255,107,53,0.03) 0%, transparent 70%)", bottom: "-100px", right: "-100px" }} />
          </div>

          <div style={{ position: "relative", zIndex: 2, maxWidth: "900px", margin: "0 auto" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "rgba(255, 107, 53, 0.1)", border: "1px solid rgba(255, 107, 53, 0.3)", padding: "6px 16px", borderRadius: "30px", fontSize: "12px", fontWeight: 700, color: "var(--orange)", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "20px" }}>
              <Navigation size={13} className="animate-pulse" /> Official F2F Seller Protocol
            </div>
            ...
            <h1 style={{
              ...
              Face-to-Face <br/>
              <span style={{ background: "linear-gradient(135deg, var(--orange), var(--gold))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Sell & Handover Guide</span>
            </h1>
            ...
            <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
              <a href="#midpoint-portal" style={{
                ...
                boxShadow: "0 4px 20px rgba(255,107,53,0.3)", textDecoration: "none", transition: "transform 0.2s"
              }}
              ...
              <a href="https://wa.me/+919025391516?text=Hi%20Maddy!%20I%20have%20an%20account%20above%20%E2%82%B980,000%20and%20want%20to%20sell%20it%20via%20Face-to-Face%20meetup."
                ...
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = "var(--orange)"; e.currentTarget.style.background = "rgba(255,107,53,0.04)"; }}
        ...
        <section style={{ padding: "60px 5% 40px", maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "45px" }}>
            <span style={{ color: "var(--orange)", fontWeight: 700, textTransform: "uppercase", fontSize: "12px", letterSpacing: "1px" }}>Secure Flow</span>
            <h2 style={{ fontFamily: "var(--font-h)", fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 800, margin: "6px 0 12px" }}>
              Timeline of a <span style={{ color: "var(--gold)" }}>Face-to-Face Sell Deal</span>
            </h2>
            ...
            {[
              {
                ...
                icon: <MessageCircle size={22} style={{ color: "var(--orange)" }} />
              },
              {
                step: "02",
                ...
                icon: <Coins size={22} style={{ color: "var(--gold)" }} />
              },
              {
                step: "03",
              ...
              <div key={stepObj.step} style={{ ...cardStyle, padding: "24px", display: "flex", flexDirection: "column", height: "100%" }}>
                <div style={glowStyle} />
                ...
                <p style={{ color: "var(--muted)", fontSize: "12.5px", lineHeight: "1.6", margin: 0, flexGrow: 1 }}>{stepObj.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="midpoint-portal" style={{ padding: "40px 5% 60px", maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "30px" }} className="portal-grid">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              <div style={cardStyle}>
                ...
                <h2 style={{ fontFamily: "var(--font-h)", fontSize: "20px", fontWeight: 800, marginBottom: "8px", display: "flex", alignItems: "center", gap: "8px" }}>
                  <Navigation size={18} style={{ color: "var(--orange)" }} /> Midpoint Map Portal
                </h2>
                <p style={{ color: "var(--muted)", fontSize: "13px", lineHeight: "1.6", marginBottom: "22px" }}>
                  All face-to-face deals are conducted strictly in South India (Tamil Nadu, Kerala, Andhra Pradesh, Karnataka). Anchored with our Buyer Agent base in **Chennai**, enter your location below to compute a balanced midpoint checkpoint ensuring **100% equal travel distance** for both parties. No one travels further!
                </p>
                        ...
                        filteredCities.map((city) => (
                          <div
                            ...
                            style={{
                              ...
                              color: selectedCity.name === city.name ? "var(--orange)" : "#fff",
                ...
                <div style={{ marginTop: "24px", padding: "16px", background: "rgba(255,107,53,0.04)", border: "1px dashed rgba(255,107,53,0.3)", borderRadius: "12px" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", padding: "10px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "8px", marginBottom: "12px" }}>
                    <div style={{ textAlign: "center" }}>
                      ...
                      <strong style={{ fontSize: "13px", color: "var(--orange)", display: "block", marginTop: "2px" }}>~{selectedCity.travelEach}</strong>
                    </div>
                    <div style={{ textAlign: "center", borderLeft: "1px dashed rgba(255,255,255,0.1)" }}>
                      <span style={{ display: "block", fontSize: "9px", color: "var(--muted)", textTransform: "uppercase", fontWeight: 700 }}>Buyer Agent Travel</span>
                      <strong style={{ fontSize: "13px", color: "var(--orange)", display: "block", marginTop: "2px" }}>~{selectedCity.travelEach}</strong>
                    </div>
                  </div>
                  ...
                  <div style={{ marginBottom: "10px" }}>
                    ...
                    <span style={{ fontSize: "12.5px", color: "var(--orange)", fontWeight: 600 }}>{selectedCity.safeLocation}</span>
                  </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{ ...cardStyle, padding: "20px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "15px" }}>
                  <span style={{ fontFamily: "var(--font-h)", fontSize: "14px", fontWeight: 700, textTransform: "uppercase", color: "#fff", display: "flex", alignItems: "center", gap: "6px" }}>
                    <Navigation size={14} style={{ color: "var(--orange)" }} /> Live Routing Vector Map
                  </span>
              ...
              <div style={cardStyle}>
                <h3 style={{ fontFamily: "var(--font-h)", fontSize: "16px", fontWeight: 800, color: "var(--gold)", margin: "0 0 10px", display: "flex", alignItems: "center", gap: "8px" }}>
                  <Coins size={16} /> 10% F2F Booking Calculator
                </h3>
                <p style={{ color: "var(--muted)", fontSize: "12px", lineHeight: "1.6", margin: "0 0 20px" }}>
                ...
                <div style={{ marginBottom: "22px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                    <span style={{ fontSize: "12px", color: "var(--muted)" }}>Account Valuation</span>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                  <div style={{ background: "rgba(255,107,53,0.04)", border: "1px solid rgba(255,107,53,0.15)", borderRadius: "10px", padding: "12px", textAlign: "center" }}>
                    <span style={{ fontSize: "10px", color: "var(--muted)", textTransform: "uppercase", display: "block", marginBottom: "4px" }}>Booking Lock (10%)</span>
                    <strong style={{ fontSize: "16px", color: "var(--orange)", fontFamily: "var(--font-h)" }}>₹ {bookingAdvance.toLocaleString()}</strong>
                  </div>
                  <div style={{ background: "rgba(34,197,94,0.04)", border: "1px solid rgba(34,197,94,0.15)", borderRadius: "10px", padding: "12px", textAlign: "center" }}>
                    <span style={{ fontSize: "10px", color: "var(--muted)", textTransform: "uppercase", display: "block", marginBottom: "4px" }}>Meetup Payout (90%)</span>
        ...
        <section style={{ padding: "20px 5% 80px", maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{
            ...
            <div style={{ position: "absolute", top: "-50px", right: "-50px", width: "150px", height: "150px", background: "radial-gradient(circle, rgba(255,215,0,0.05) 0%, transparent 70%)", pointerEvents: "none" }} />
            ...
            <div style={{ display: "flex", gap: "24px" }} className="mandate-flex">
              <div style={{ display: "flex", flexDirection: "column", gap: "10px", maxWidth: "800px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" }}>
                  <ShieldAlert size={24} style={{ color: "var(--gold)" }} />
                ...
                <p style={{ color: "var(--muted)", fontSize: "13.5px", lineHeight: "1.7", margin: "0 0 10px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  <div>
                    ...
                    <span style={{ color: "var(--muted)", fontSize: "12.5px", lineHeight: "1.5" }}>Before any payout is disbursed, we collect physical verification of government-issued IDs (Aadhaar Card or Driving License) with your live location. PAN cards alone are not accepted.</span>
                  </div>
                  <div>
                    <strong style={{ color: "#fff", fontSize: "14px", display: "block", marginBottom: "2px" }}>2. Irreversible Handover & Finality</strong>
                    <span style={{ color: "var(--muted)", fontSize: "12.5px", lineHeight: "1.5" }}>Once our agent detaches bindings and ownership has been handed over to the buyer, the deal is 100% absolute. Accounts cannot be returned under any circumstances.</span>
                  </div>
                  <div>
                    <strong style={{ color: "#fff", fontSize: "14px", display: "block", marginBottom: "2px" }}>3. 100% Locked Payout Guarantee</strong>
                    <span style={{ color: "var(--muted)", fontSize: "12.5px", lineHeight: "1.5" }}>Your Wholesale Payout amount is secured and locked instantly during verification. Payments are processed in legal cash or instant Bank Transfer/UPI before we exit the meetup.</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", flexShrink: 0, minWidth: "220px", borderLeft: "1px dashed rgba(255,255,255,0.1)", paddingLeft: "24px" }} className="mandate-cta-col">
                <span style={{ fontSize: "12px", color: "var(--muted)", marginBottom: "8px", textTransform: "uppercase", fontWeight: 700 }}>Slot Booking Available</span>
                <strong style={{ fontSize: "16px", color: "var(--orange)", display: "block", marginBottom: "16px", textAlign: "center", fontFamily: "var(--font-h)" }}>Book a Verified Agent Slot</strong>
