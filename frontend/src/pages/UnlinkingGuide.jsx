...
import { UserCheck, Key, ArrowLeft, Mail, RefreshCw, CheckCircle, Info, Lock } from "lucide-react";

export default function UnlinkingGuide() {
  useSEO(
    "Personal Login & Unlinking Security Guide",
    "Learn about our strict login custody policies, personal email protection, and guaranteed social unlinking timelines."
  );
      ...
      <div style={containerStyle}>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{
              ...
              Personal Logins & <br/>
              <span style={{ background: "linear-gradient(135deg, #60a5fa, var(--gold))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Unlinking Guidelines</span>
            </h1>
        ...
        <section style={{ padding: "50px 5% 80px", maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "12px", background: "rgba(96,165,250,0.02)", border: "1px dashed rgba(96,165,250,0.2)", borderRadius: "12px", padding: "20px" }}>
                <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  ...
                  <span style={{ fontSize: "13.5px", color: "#e2e2e2", lineHeight: 1.5 }}>
                    **Game Login Custody:** Maddy Store secures primary active logins (e.g., Twitter/X link or dedicated game-linked email) to pass to the buyer.
                  </span>
                </div>
                <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  <CheckCircle size={15} style={{ color: "#60a5fa", flexShrink: 0, marginTop: "3px" }} />
                  <span style={{ fontSize: "13.5px", color: "#e2e2e2", lineHeight: 1.5 }}>
                    **Personal Logins Remain Yours:** If the account has secondary linkages (such as a personal Gmail or personal Facebook), you retain absolute control over these assets. We guide you on unlinking them safely without ever requesting their login credentials.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div style={cardStyle}>
              <h2 style={{ fontFamily: "var(--font-h)", fontSize: "20px", fontWeight: 800, color: "#fff", margin: "0 0 16px", display: "flex", alignItems: "center", gap: "10px" }}>
                <RefreshCw size={20} style={{ color: "var(--gold)" }} /> 2. Guaranteed Unlinking Window
              </h2>
              <p style={{ color: "var(--muted)", fontSize: "14px", lineHeight: "1.7", marginBottom: "16px" }}>
            ...
            {/* Important Notice */}
            <div style={{ ...cardStyle, border: "1px dashed rgba(255,215,0,0.3)", background: "rgba(255,215,0,0.01)" }}>
              <h2 style={{ fontFamily: "var(--font-h)", fontSize: "18px", fontWeight: 800, color: "var(--gold)", margin: "0 0 12px", display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div style={{ textAlign: "center", marginTop: "40px" }}>
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = "#60a5fa"; e.currentTarget.style.background = "rgba(96,165,250,0.03)"; }}
