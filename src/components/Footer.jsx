...
import { ShoppingCart, Banknote, KeyRound, Star, Heart, Eye, Scale, Shield, RotateCcw, HelpCircle } from "lucide-react";
...
const socials = [
  {
    ...
    icon: <svg viewBox="0 0 24 24" fill="url(#ig-grad)" width="16" height="16"><defs><linearGradient id="ig-grad" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#f09433" /><stop offset="50%" stopColor="#dc2743" /><stop offset="100%" stopColor="#bc1888" /></linearGradient></defs><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" /></svg>,
  },
  {
...
// Contact items with inline icons
const contacts = [
  {
  ...
  },
  {
    ...
    color: "#229ED9",
    icon: <svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg>,
  },
  {
    href: "https://www.instagram.com/maddy_bgmistore/",
    label: "Contact Us on Instagram",
    color: "#E1306C",
    icon: <svg viewBox="0 0 24 24" fill="url(#ig-grad2)" width="15" height="15"><defs><linearGradient id="ig-grad2" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#f09433" /><stop offset="50%" stopColor="#dc2743" /><stop offset="100%" stopColor="#bc1888" /></linearGradient></defs><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" /></svg>,
  },
  {
    href: "mailto:maddybgmistoreog@gmail.com",
    label: "Contact Us Via Email",
    color: "#EA4335",
    icon: <svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.91 1.528-1.145C21.69 2.28 24 3.434 24 5.457z" /></svg>,
  },
];
  ...
  return (
    <footer style={{ background: "var(--bg2)", borderTop: "1px solid rgba(255,215,0,0.18)", padding: "60px 5% 20px" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "40px", marginBottom: "40px" }}>
        ...
        {/* Brand */}
        <div>
          <div style={{ fontFamily: "var(--font-h)", fontSize: "20px", fontWeight: 700, color: "var(--gold)", letterSpacing: "2px", marginBottom: "12px" }}>
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            {socials.map((s, i) => (
              <a key={i} href={s.href} target="_blank" rel="noreferrer"
                style={{ width: "36px", height: "36px", borderRadius: "9px", background: s.bg, border: `1px solid ${s.border}`, display: "flex", alignItems: "center", justifyContent: "center", color: s.color, textDecoration: "none", transition: "transform .2s, opacity .2s" }}
        ...
        {/* Quick Links */}
        <div>
          <div style={{ fontFamily: "var(--font-h)", fontSize: "12px", fontWeight: 700, color: "var(--gold)", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "16px" }}>Quick Links</div>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              ...
              { to: "/refunds", label: "Refund Policy", icon: <RotateCcw size={13} /> },
        ...
        {/* Contact with inline icons */}
        <div>
          <div style={{ fontFamily: "var(--font-h)", fontSize: "12px", fontWeight: 700, color: "var(--gold)", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "16px" }}>Contact Support</div>
          <div style={{ display: "flex", flexDirection: "column", gap: "11px" }}>
            {contacts.map((c, i) => (
              <a key={i} href={c.href} target="_blank" rel="noreferrer"
                style={{ display: "flex", alignItems: "center", gap: "9px", color: "var(--muted)", fontSize: "13px", textDecoration: "none", transition: "color .2s" }}
                onMouseEnter={e => e.currentTarget.style.color = "var(--text)"}
                onMouseLeave={e => e.currentTarget.style.color = "var(--muted)"}
              >
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: "20px", textAlign: "center", fontSize: "12px", color: "var(--muted)" }}>
        ...
        Made with <Heart size={11} fill="#ef4444" color="#ef4444" style={{ display: "inline", verticalAlign: "middle", margin: "0 2px" }} /> in South India &nbsp;·&nbsp; © 2026 <Link to="/terms" style={{ color: "var(--gold)", textDecoration: "none", transition: "opacity 0.2s" }} onMouseEnter={e => e.currentTarget.style.opacity = 0.8} onMouseLeave={e => e.currentTarget.style.opacity = 1}>Maddy BGMI Store</Link> &nbsp;·&nbsp; <Link to="/terms" style={{ color: "var(--muted)", textDecoration: "underline", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "var(--gold)"} onMouseLeave={e => e.currentTarget.style.color = "var(--muted)"}>Terms & Conditions</Link> &nbsp;·&nbsp; <Link to="/privacy" style={{ color: "var(--muted)", textDecoration: "underline", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "var(--gold)"} onMouseLeave={e => e.currentTarget.style.color = "var(--muted)"}>Privacy Policy</Link> &nbsp;·&nbsp; <Link to="/refunds" style={{ color: "var(--muted)", textDecoration: "underline", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "var(--gold)"} onMouseLeave={e => e.currentTarget.style.color = "var(--muted)"}>Refund Policy</Link> &nbsp;·&nbsp; <Link to="/faq" style={{ color: "var(--muted)", textDecoration: "underline", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "var(--gold)"} onMouseLeave={e => e.currentTarget.style.color = "var(--muted)"}>FAQs</Link> &nbsp;·&nbsp; Not affiliated with BGMI or Krafton.
      </div>
    </footer>
  );
}
