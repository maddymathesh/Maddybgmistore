...
export default function ConnectWithUs() {
  useSEO(
    ...
    "Join Maddy BGMI Store's official WhatsApp channel, Telegram communities, Instagram, and YouTube for live listings and verified success proofs."
  );
  return (
    <>
      <Navbar />
            ...
            {links.map(({ label, href, bg, glow, Icon }) => (
              <a
                ...
                className={`
                  ...
                  text-white font-extrabold text-[14px] sm:text-[16px] tracking-[1px] sm:tracking-[1.5px] uppercase
