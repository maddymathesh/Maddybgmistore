...
import { ShieldCheck, AlertTriangle, HelpCircle, ArrowLeft, TrendingDown, RefreshCw, BarChart } from "lucide-react";

export default function NoReturnsPolicy() {
  useSEO(
    "No Returns After Handover Policy",
    "Understanding Maddy BGMI Store's irrevocable handover policy and why all premium account sales are final."
  );
      ...
      <div style={containerStyle}>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            ...
            <h1 style={{
              ...
              No Returns After <br/>
              <span style={{ background: "linear-gradient(135deg, #ff6b6b, var(--gold))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Handover Policy</span>
            </h1>
        ...
        <section style={{ padding: "50px 5% 80px", maxWidth: "900px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "30px" }}>
            ...
            <div style={cardStyle}>
              <h2 style={{ fontFamily: "var(--font-h)", fontSize: "20px", fontWeight: 800, color: "#fff", margin: "0 0 16px", display: "flex", alignItems: "center", gap: "10px" }}>
                <TrendingDown size={20} style={{ color: "var(--orange)" }} /> 1. Protection of Store Profit Margins
              </h2>
            ...
            <div style={cardStyle}>
              <h2 style={{ fontFamily: "var(--font-h)", fontSize: "20px", fontWeight: 800, color: "#fff", margin: "0 0 16px", display: "flex", alignItems: "center", gap: "10px" }}>
                <HelpCircle size={20} style={{ color: "var(--gold)" }} /> 3. Why This Ensures Absolute Fairness
              </h2>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "12px" }}>
                <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "var(--gold)", marginTop: "8px", flexShrink: 0 }} />
                  <span style={{ fontSize: "13.5px", color: "#e2e2e2", lineHeight: 1.5 }}>
                    **Seller Guarantee:** Your payment is locked, verified, and 100% immune to subsequent reversals or buyer claims once verified by Maddy Store.
                  </span>
                </div>
                <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "var(--gold)", marginTop: "8px", flexShrink: 0 }} />
                  <span style={{ fontSize: "13.5px", color: "#e2e2e2", lineHeight: 1.5 }}>
                    **Buyer Guarantee:** The buyer receives a thoroughly audited, isolated, and permanently bound account free of security retrieval risks.
                  </span>
                </div>
              </div>
            </div>
          ...
          <div style={{ textAlign: "center", marginTop: "40px" }}>
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = "#ff6b6b"; e.currentTarget.style.background = "rgba(239,68,68,0.03)"; }}
