...
export default function RefundPolicy() {
  ...
  const sections = [
    ...
    {
      id: "custom-sourcing",
      icon: <RotateCcw size={20} style={{ color: "var(--gold)" }} />,
    ...
    {
      id: "exact-match",
      icon: <AlertCircle size={20} style={{ color: "var(--gold)" }} />,
    ...
    },
    {
      ...
      icon: <CheckCircle2 size={20} style={{ color: "var(--gold)" }} />,
    ...
    <>
      ...
      <div style={{ paddingTop: "102px", background: "var(--bg)", minHeight: "100vh" }}>
        ...
        <section style={{
          ...
          <img src="/refund-banner.jpg" alt="Refund Policy" loading="lazy" decoding="async"
          ...
          <div style={{ position: "relative", zIndex: 2, padding: "0 5%", maxWidth: "760px" }}>
            <div className="badge" style={{ marginBottom: "16px", letterSpacing: "2px" }}>REFUND GUIDE</div>
            <h1 style={{ fontFamily: "var(--font-h)", fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, color: "#fff", lineHeight: 1.2, textShadow: "0 2px 25px rgba(0,0,0,0.7)" }}>
              Refund &amp; <span style={{ color: "var(--gold)" }}>Return Policy</span>
            </h1>
